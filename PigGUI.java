...
****************************************************************/    
 public static void main(String args[]){
        ...
        gui.setTitle("Game of Pig: By Alex Porter");
        gui.pack();
        gui.setVisible(true);
    }
...
public PigGUI(){ 
    ...
    //registers the listeners for the three buttons
    ...
    // place computer button below second die
    panelPosition.gridx = 2;
    panelPosition.gridy = 2;
...
public void actionPerformed(ActionEvent e){
    ...
    // check if player rolls
    if (buttonPressed == roll) {
        game.playerRolls();
    }

        
    // check if player holds 
    ...
    if (game.isPlayerTurn()){
        ...
        //game.computerTurn();
        //forces user to click Computer after each turn
    }
    ...
    // display winning message if player or computer wins
    if(game.playerWon() && game.getPlayerScore() >= 100) {
        JOptionPane.showMessageDialog(null, "Player Wins!");
        game.restart();
    }
    else if(game.computerWon() && game.getComputerScore() >= 100) {
